...
public class Create {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        List<Callable<String>> sessionsToExecute = IntStream.range(0,20).mapToObj(index-> new CreateCollable(dbBroker,kotikByte,getAnimalsToCreate())).collect(Collectors.toList());
